...
3.  ValidationBehavior - Her request'ten önce validasyon çalışır
4.  AuditingBehavior - Her command sonrası audit log kaydı oluşturur
...
5.  Veritabanı Katmanı (DbContext)
    3.1 AppDbContext
...
7.  Pipeline Behaviors (Otomatik İşlemler)
